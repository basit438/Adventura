...
{
    public partial class chosedcampingitempage : System.Web.UI.Page
    {
        ...
        {
            Label rid = new Label();
            rid = (Label)e.Item.FindControl("renderidLabel");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            str = "set dateformat dmy;insert into [camping_item_BookingDetail] values('" + Session["itemid"].ToString() + "','" + ViewState["renderid"].ToString() + "','" + Session["uid"].ToString()
