<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/CustomerMasterPage.Master" AutoEventWireup="true" CodeBehind="AdventureItempage.aspx.cs" Inherits="Adventura.Customer.AdventureItempage" %>
...
<asp:DropDownList style="height:40px; margin-left:30px; margin-top:10px;" class="input-group w-75 form-control" id="ddlvhcategory" runat="server" height="33px" width="452px" AutoPostBack="True" OnSelectedIndexChanged="ddlvhcategory_SelectedIndexChanged">
    ...
    <asp:ListItem>4 wheeler</asp:ListItem>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [AdventureItemid], [AdventureItemName], [AdventureItemType], [Itemdescription], [itemcolor], [itemCategory], [rent], [per], [itemimage] FROM [AdventureItemDetailView]"></asp:SqlDataSource>
    </div>
            </asp:View>
                ...
                <div>
                    <asp:DataList ID="DataList2" runat="server" DataKeyField="itemDetailID" DataSourceID="SqlDataSource2" OnItemCommand="DataList2_ItemCommand">
                        <ItemTemplate>
                            ...
                            <asp:Image class="img-fluid" ID="Image2" runat="server" ImageUrl='<%# "../ItemImages/" + Eval("itemimage") %>'/>
                            ...
                            <center>
                        <h1> <asp:Label ID="Label1" runat="server" Text='<%# Eval("AdventureItemName") %>' />
                            ...
                            <br />
                                      ...
                                      ID:<asp:Label ID="Label2" runat="server" Text='<%# Eval("AdventureItemid") %>' /> <br />
                                    Rent:
                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("rent") %>' />
                            
                            per/
                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("per") %>' /> <br />
